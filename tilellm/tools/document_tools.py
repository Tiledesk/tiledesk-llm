...
async def _handle_trafilatura_scrape(url: str, headers: Optional[dict] = None) -> list[Document]:
    ...
    # favor_precision drops tiny main content on chrome-heavy pages (e.g. PA
    # portals where only the cookie banner survives): retry without it and
    # keep the longer extraction.
